  ...
  order.forEach(function (key, index) {
    ...
    (item.tiles || []).forEach(function (tile) {
      ...
      if (tile.type === 'text') {
        ...
        img.src = tile.src || '';
        img.alt = tile.alt || '';
        if (tile.objectPosition) {
          img.style.objectPosition = tile.objectPosition;
        }
        ...
        (tile.hotspots || []).forEach(function (hotspot) {
          ...
          var style = '--x:' + x + '%;--y:' + y + '%;';
          if (typeof hotspot.xMobile === 'number') {
            style += '--x-mobile:' + hotspot.xMobile + '%;';
          }
          if (typeof hotspot.yMobile === 'number') {
            style += '--y-mobile:' + hotspot.yMobile + '%;';
          }
